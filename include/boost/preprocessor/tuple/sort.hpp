...
#  define BOOST_PP_TS_MERGE_R(D,R,I,X) BOOST_PP_IF(BOOST_PP_LESS(X, BOOST_PP_ARRAY_ELEM(L, R)), BOOST_PP_ARRAY_INSERT,    BOOST_PP_TS_GETR)(D,R,I,X)
#  define BOOST_PP_TS_MERGE_U(D,R,I,X) BOOST_PP_IF(BOOST_PP_LESS(I, BOOST_PP_ARRAY_SIZE(   R)), BOOST_PP_TS_MERGE_R, BOOST_PP_ARRAY_INSERT)(D,R,I,X)
