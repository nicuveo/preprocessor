...
#  define BOOST_PP_TS_MERGE_R(D,R,I,X) BOOST_PP_IF(BOOST_PP_LESS(X, BOOST_PP_ARRAY_ELEM(I, R)), BOOST_PP_ARRAY_INSERT_D,    BOOST_PP_TS_GETR)(D,R,I,X)
#  define BOOST_PP_TS_MERGE_U(D,R,I,X) BOOST_PP_IF(BOOST_PP_LESS(I, BOOST_PP_ARRAY_SIZE(   R)), BOOST_PP_TS_MERGE_R, BOOST_PP_ARRAY_INSERT_D)(D,R,I,X)
...
#  define BOOST_PP_TS_OP_2(D,T,I,R,X)   (T,                             \
                                         BOOST_PP_INC(I),               \
                                         BOOST_PP_ARRAY_INSERT_D(D, R, BOOST_PP_ARRAY_LOWER_BOUND_D(D,R,X), X))
